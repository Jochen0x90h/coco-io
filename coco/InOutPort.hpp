...
/// @brief Virtual port of general purpose input/output pins with output enable.
/// The initial direction (input or output) is implementation dependent.
class InOutPort : public InputPort, public OutputPort {
public:

    ~InOutPort() override {}

    /// @brief Enable the output driver
