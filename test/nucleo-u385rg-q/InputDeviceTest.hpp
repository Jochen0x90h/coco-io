...
struct Drivers {
    ...
    static constexpr gpio::Config inputPinConfigs[] {
        ...
        // input 3: blue user button (on nucleo board, pull-downn not fitted, EXTI13)
    ...
    static constexpr InputDevice::Config inputConfigs[] {
        ...
        // brotary knob push button press (listen on input 2, modify counter 1)
        {2, 1, InputDevice::Init::INPUT, InputDevice::Action::INCREMENT, InputDevice::Action::NONE, 10ms, 10ms},

        // rotary knob push button long press (listen on input 2, modify counter 2)
